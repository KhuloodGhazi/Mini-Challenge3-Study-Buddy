...
class ViewControllerJoin: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ParIma.isAccessibilityElement = true
        ParIma.accessibilityLabel = "By"
        ParIma.accessibilityHint = "The hint is. This is the person who create this study group"
...
//        let controller = storyboard?.instantiateViewController(withIdentifier: "DoneJoin") as! JoinViewController
