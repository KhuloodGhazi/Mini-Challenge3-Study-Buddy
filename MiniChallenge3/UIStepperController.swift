...
//  MiniChallenge3
//
//  Created by Khulood  on 06/08/1443 AH.
//
...
//    private let subtractionButtonImage: UIImageView = UIImageView()
    ...
    private func commonInit() {
        ...
        // *************** Center UILabel ****************
        self.countLable.font = UIFont.systemFont(ofSize: 18)
        self.countLable.textColor = UIColor(named: "black")
        self.countLable.text = isFloat ? String(format: "%.2f", _count) : String(format: "%.0f", _count)
        ...
        // *************** Left Button ****************
        self.subtractionButtonView.layer.borderColor = UIColor(named: "Yellow")?.cgColor
        ...
        let subtractionButtonWidthConstraint = NSLayoutConstraint(item: self.subtractionButtonView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 25)
...
//        self.subtractionButtonView.addSubview(self.subtractionButtonImage)
        ...
        let subtractionIconViewHeightConstraint = NSLayoutConstraint(item: self.subtractionIconView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 5)
        let subtractionIconViewWidthConstraint = NSLayoutConstraint(item: self.subtractionIconView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 5)
        ...
        self.crossShape01.frame = CGRect(x: -2, y: 4, width: 10, height: 2)
        self.crossShape01.backgroundColor = UIColor.black
        ...
        // *************** Right Button ****************
        self.additionButtonView.layer.borderColor = UIColor(named: "Yellow")?.cgColor
        ...
        let additionButtonViewWidthConstraint = NSLayoutConstraint(item: self.additionButtonView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 25)
...
//        self.additionButtonView.addSubview(self.additionButtonImage)
        ...
        let additionIconViewHeightConstraint = NSLayoutConstraint(item: self.additionIconView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 5)
        let additionIconViewWidthConstraint = NSLayoutConstraint(item: self.additionIconView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 5)
        ...
        self.crossShape02.frame = CGRect(x: 1, y: -1, width: 2, height: 13)
        self.crossShape02.backgroundColor = UIColor.black
        self.additionIconView.addSubview(self.crossShape02)
        
        self.crossShape03.frame = CGRect(x: -4, y: 4, width: 13, height: 2)
        self.crossShape03.backgroundColor = UIColor.black
